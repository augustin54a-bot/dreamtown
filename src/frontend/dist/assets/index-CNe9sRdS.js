...
const RSVP_OPTIONS$1 = ["Accepted", "Pending", "Declined"];
function CreateEventModal({
  ...
  const [title, setTitle] = reactExports.useState((existingEvent == null ? void 0 : existingEvent.title) ?? "");
  const [secretMessage, setSecretMessage] = reactExports.useState(
    (existingEvent == null ? void 0 : existingEvent.secretMessage) ?? ""
  );
  const [eventDate, setEventDate] = reactExports.useState(
    (existingEvent == null ? void 0 : existingEvent.eventDate) ? new Date(existingEvent.eventDate).toISOString().slice(0, 16) : ""
  );
  const [location2, setLocation] = reactExports.useState((existingEvent == null ? void 0 : existingEvent.location) ?? "");
  const [password, setPassword] = reactExports.useState((existingEvent == null ? void 0 : existingEvent.password) ?? "");
  const [eventType, setEventType] = reactExports.useState(
    (existingEvent == null ? void 0 : existingEvent.eventType) ?? "party"
  );
  const [guests, setGuests] = reactExports.useState((existingEvent == null ? void 0 : existingEvent.guests) ?? []);
  ...
  const validate = () => {
    ...
    if (!location2.trim()) e.location = "Location is required";
    setErrors(e);
  ...
  const handleSave = () => {
    if (!validate()) return;
    const event = {
      id: (existingEvent == null ? void 0 : existingEvent.id) ?? generateId(),
      title: title.trim(),
      ...
      eventType,
      guests,
      isCompleted: (existingEvent == null ? void 0 : existingEvent.isCompleted) ?? false,
      isRevealed: (existingEvent == null ? void 0 : existingEvent.isRevealed) ?? false,
      createdAt: (existingEvent == null ? void 0 : existingEvent.createdAt) ?? (/* @__PURE__ */ new Date()).toISOString()
    };
    onSave(event);
  };
  const overlayStyle = {
  ...
  const inputStyle = {
    ...
    border: isDark ? "1px solid rgba(255,255,255,0.10)" : "1px solid rgba(0,0,0,0.1)",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  background: isDark ? "rgba(20, 26, 42, 0.97)" : "rgba(255, 255, 255, 0.98)",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h2",
                    {
                      ...
                      children: existingEvent ? "✏️ Edit Surprise" : "✨ New Surprise Event"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 17, style: { color: isDark ? "#AEB6D0" : "#888" } })
                    }
                  )
                ]
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium mb-2", style: labelStyle, children: "Event Type" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: EVENT_TYPES.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    style: {
                      background: eventType === t ? "linear-gradient(135deg, #6FA8FF, #B98CFF)" : isDark ? "rgba(255,255,255,0.07)" : "rgba(0,0,0,0.06)",
                      color: eventType === t ? "#fff" : isDark ? "#AEB6D0" : "#666",
                      border: eventType === t ? "none" : isDark ? "1px solid rgba(255,255,255,0.08)" : "1px solid rgba(0,0,0,0.08)"
                    },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  errors.eventDate && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "#ff6b6b" }, children: errors.eventDate })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "label",
                  ...
                  errors.location && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "#ff6b6b" }, children: errors.location })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "label",
                  {
                    ...
                    className: "text-xs font-medium mb-1 block",
                    style: labelStyle,
                    children: "Password Lock (optional) 🔒"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium mb-2", style: labelStyle, children: "Guest List" }),
                ...
                guests.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1 max-h-36 overflow-y-auto", children: guests.map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "select",
                        {
                          ...
                          style: {
                            ...
                            color: g.rsvp === "Accepted" ? "#3CCB7A" : g.rsvp === "Declined" ? "#ff6b6b" : "#E0B34A"
                          },
                          "data-ocid": "create_event.select",
                          children: RSVP_OPTIONS$1.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: r2, children: r2 }, r2))
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                ...
                guests.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: "flex items-center gap-2 px-3 py-2 rounded-lg",
                    style: {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "text-xs",
                          style: { color: isDark ? "#7D86A6" : "#bbb" },
                          children: "No guests yet — add some above"
                        }
                      )
                    ]
                  }
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: existingEvent ? "Save Changes" : "Create Event ✨"
                    }
                  )
                ]
              }
...
function CountdownTimer({ targetDate, isDark }) {
  const [timeLeft, setTimeLeft] = reactExports.useState(getTimeLeft(targetDate));
  reactExports.useEffect(() => {
  ...
  if (timeLeft.expired) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold", style: { color: "#3CCB7A" }, children: "Time's up!" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 countdown-digit text-xs font-semibold", children: [
    timeLeft.days > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isDark ? "#6FA8FF" : "#4a7fd4" }, children: String(timeLeft.days).padStart(2, "0") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isDark ? "#7D86A6" : "#888" }, children: ":" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isDark ? "#6FA8FF" : "#4a7fd4" }, children: String(timeLeft.hours).padStart(2, "0") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isDark ? "#7D86A6" : "#888" }, className: "text-xs", children: "h" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isDark ? "#7D86A6" : "#888" }, children: ":" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isDark ? "#B98CFF" : "#8a6fd8" }, children: String(timeLeft.minutes).padStart(2, "0") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isDark ? "#7D86A6" : "#888" }, className: "text-xs", children: "m" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isDark ? "#7D86A6" : "#888" }, children: ":" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isDark ? "#B98CFF" : "#8a6fd8" }, children: String(timeLeft.seconds).padStart(2, "0") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isDark ? "#7D86A6" : "#888" }, className: "text-xs", children: "s" })
  ] });
}
...
function EventCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...cardStyle,
        boxShadow: isDark ? "0 8px 32px rgba(0,0,0,0.35)" : "0 4px 20px rgba(0,0,0,0.1)"
      },
      "data-ocid": "event.card",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-full", style: { background: gradient } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: compact ? "p-3" : "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: getEventIcon(event.eventType) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              event.password && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Lock,
                {
                  size: 13,
              ...
              event.isCompleted && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
          ...
          !event.isCompleted && !isPast && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountdownTimer, { targetDate: event.eventDate, isDark }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-1 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              MapPin,
              {
                size: 12,
          ...
          !compact && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                background: isDark ? "rgba(10, 15, 25, 0.35)" : "rgba(111, 168, 255, 0.08)",
                border: isDark ? "1px solid rgba(255,255,255,0.06)" : "1px solid rgba(111,168,255,0.15)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 12, style: { color: isDark ? "#7D86A6" : "#999" } }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex -space-x-1", children: [
                event.guests.slice(0, 3).map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                event.guests.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: event.guests.length
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              secretMode && !event.isRevealed && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: (e) => {
                  ...
                  children: showSecret ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    EyeOff,
                    {
                      size: 13,
              ...
              event.isCompleted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
...
function GuestTable({ events: events2, isDark, onUpdateRsvp }) {
  const [filterRsvp, setFilterRsvp] = reactExports.useState("All");
  const allGuests = events2.flatMap(
    (e) => e.guests.map((g) => ({ ...g, eventTitle: e.title, eventId: e.id }))
  );
  const filtered = filterRsvp === "All" ? allGuests : allGuests.filter((g) => g.rsvp === filterRsvp);
  const rsvpColor = (rsvp) => rsvp === "Accepted" ? "#3CCB7A" : rsvp === "Declined" ? "#ff6b6b" : "#E0B34A";
  const rsvpBg = (rsvp, dark) => rsvp === "Accepted" ? dark ? "rgba(60,203,122,0.15)" : "rgba(60,203,122,0.1)" : rsvp === "Declined" ? dark ? "rgba(255,107,107,0.15)" : "rgba(255,107,107,0.1)" : dark ? "rgba(224,179,74,0.15)" : "rgba(224,179,74,0.1)";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-4", "data-ocid": "guests.tab", children: ["All", "Accepted", "Pending", "Declined"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        ...
        style: {
          background: filterRsvp === f ? "linear-gradient(135deg, #6FA8FF, #B98CFF)" : isDark ? "rgba(255,255,255,0.07)" : "rgba(0,0,0,0.06)",
          color: filterRsvp === f ? "#fff" : isDark ? "#AEB6D0" : "#666",
          border: filterRsvp === f ? "none" : isDark ? "1px solid rgba(255,255,255,0.08)" : "1px solid rgba(0,0,0,0.08)"
        },
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ["Guest", "Email", "Event", "RSVP", "Action"].map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              filtered.map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      {
                        value: g.rsvp,
                        onChange: (e) => onUpdateRsvp(g.eventId, g.id, e.target.value),
                        className: "text-xs rounded-lg px-2 py-1",
                        style: {
                          background: isDark ? "rgba(255,255,255,0.07)" : "rgba(0,0,0,0.05)",
                          border: isDark ? "1px solid rgba(255,255,255,0.1)" : "1px solid rgba(0,0,0,0.1)",
                        ...
                        children: RSVP_OPTIONS.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: r2, children: r2 }, r2))
                      }
                    )
                  },
                  `action-${g.id}`
...
function Notifications({
  ...
  const alerts = events2.filter((e) => !e.isCompleted && !dismissed.includes(e.id)).map((e) => {
    const eventDate = new Date(e.eventDate);
    const diffMs = eventDate.getTime() - now2.getTime();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mb-6", children: alerts.map((alert) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "fade-in flex items-center justify-between gap-3 rounded-xl px-4 py-3",
      style: {
        background: alert.urgent ? isDark ? "rgba(210, 124, 255, 0.18)" : "rgba(180, 100, 255, 0.12)" : isDark ? "rgba(111, 168, 255, 0.15)" : "rgba(85, 140, 255, 0.10)",
        border: `1px solid ${alert.urgent ? isDark ? "rgba(210, 124, 255, 0.35)" : "rgba(180, 100, 255, 0.3)" : isDark ? "rgba(111, 168, 255, 0.3)" : "rgba(85, 140, 255, 0.25)"}`
      },
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 14, style: { color: isDark ? "#AEB6D0" : "#666" } })
          }
        )
      ]
    },
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { size: 14, className: "text-white" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 16, style: { color: isDark ? "#AEB6D0" : "#888" } })
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                ...
                children: [
                  ...
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { style: { color: isDark ? "#F2F4FF" : "#1a1a2e" }, children: [
                    '"',
                    eventTitle,
                    '"'
                  ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "unlock-password", className: "sr-only", children: "Password" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "unlock-password",
  ...
  return [
    {
      ...
      secretMessage: "We have reserved the rooftop garden at The Orchard restaurant! 🎂 Dress code is garden party chic. Emma has no idea!",
      eventDate: addDays(now2, 5).toISOString(),
      location: "The Orchard Rooftop, 42 Blossom Lane, NYC",
      password: "emma123",
      isCompleted: false,
      isRevealed: false,
      createdAt: subtractDays(now2, 10).toISOString(),
      eventType: "birthday",
      guests: [
        {
          id: "g1",
    ...
    },
    {
      ...
      secretMessage: "Booked a private table at Luminara Sky Dining — 80th floor, sunset view. The ring is hidden in the dessert. She said she loves chocolate lava cake!",
      eventDate: addDays(now2, 34).toISOString(),
      location: "Luminara Sky Dining, 1 Cloud Tower, Chicago",
      isCompleted: false,
      isRevealed: false,
      createdAt: subtractDays(now2, 2).toISOString(),
      eventType: "proposal",
      guests: [
        {
          id: "g5",
    ...
    },
    {
      ...
      secretMessage: "We surprised Alex with a rooftop party and a trip to Lisbon! Everyone was there. The look on their face was priceless.",
      eventDate: subtractDays(now2, 15).toISOString(),
      location: "Skyline Terrace, 88 Graduate Ave, Boston",
      isCompleted: true,
      isRevealed: true,
      createdAt: subtractDays(now2, 45).toISOString(),
      eventType: "party",
      guests: [
        {
          id: "g7",
...
function App() {
  const [events2, setEvents] = useLocalStorage(
    "surprise-events",
    initEvents()
  );
  ...
  const [editingEvent, setEditingEvent] = reactExports.useState(
    void 0
  );
  const [revealingEvent, setRevealingEvent] = reactExports.useState(void 0);
  const [dismissedNotifs, setDismissedNotifs] = useLocalStorage(
    "surprise-dismissed-notifs",
    []
  );
  const { triggerConfetti } = useConfetti();
  const now2 = reactExports.useMemo(() => /* @__PURE__ */ new Date(), []);
  const filteredEvents = reactExports.useMemo(() => {
    ...
    if (statusFilter === "upcoming")
      result = result.filter(
        (e) => !e.isCompleted && new Date(e.eventDate) > now2
      );
    ...
    return result;
  }, [events2, search, statusFilter, now2]);
  const upcomingEvents = reactExports.useMemo(
    () => events2.filter((e) => !e.isCompleted && new Date(e.eventDate) > now2),
    [events2, now2]
  );
  const completedEvents = reactExports.useMemo(
    () => events2.filter((e) => e.isCompleted),
    [events2]
  );
  const todayEvents = reactExports.useMemo(
    () => events2.filter(
      (e) => new Date(e.eventDate).toDateString() === now2.toDateString()
    ),
    [events2, now2]
  );
  const handleReveal = (event) => {
    const eventDate = new Date(event.eventDate);
    if (!event.isCompleted && eventDate > now2) {
      ue.error("⏳ Not yet! The reveal timer hasn't ended.");
      return;
    }
  ...
  const doReveal = (event) => {
    setEvents(
      (prev) => prev.map(
        (e) => e.id === event.id ? { ...e, isRevealed: true, isCompleted: true } : e
      )
    );
    triggerConfetti();
    ue.success(`🎉 "${event.title}" is REVEALED!`);
  };
  const handlePasswordConfirm = (password) => {
    if (!revealingEvent) return;
    if (password === revealingEvent.password) {
      const eventToReveal = revealingEvent;
      setRevealingEvent(void 0);
      doReveal(eventToReveal);
    } else {
      ue.error("🔒 Wrong password!");
    }
  };
  const handleSaveEvent = (event) => {
    ...
    ue.success(`✨ "${event.title}" saved!`);
  };
  const handleDeleteEvent = (id) => {
    setEvents((prev) => prev.filter((e) => e.id !== id));
    ue.success("Event deleted");
  };
  const handleUpdateRsvp = (eventId, guestId, rsvp) => {
    setEvents(
      (prev) => prev.map(
        (e) => e.id === eventId ? {
          ...e,
          guests: e.guests.map(
            (g) => g.id === guestId ? { ...g, rsvp } : g
          )
        } : e
      )
    );
  ...
  const handleExportPDF = (event) => {
    const printContent = `
      <html><head><title>${event.title}</title><style>
        ...
        <p style="color:#999;font-size:12px;margin-top:40px;">Generated by SurpriseIt · ${(/* @__PURE__ */ new Date()).toLocaleDateString()}</p>
      </body></html>
    `;
  ...
  const bgStyle = isDark ? {
    background: "linear-gradient(135deg, #070A1A 0%, #0B1230 50%, #0A1D3A 100%)",
    position: "relative",
    overflow: "hidden"
  } : {
    background: "linear-gradient(135deg, #EEF0FF 0%, #F5F0FF 50%, #EDF5FF 100%)",
    position: "relative",
    overflow: "hidden"
  };
  ...
  const tabs = [
    {
      id: "dashboard",
      label: "Dashboard",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutDashboard, { size: 14 })
    },
    { id: "events", label: "Events", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { size: 14 }) },
    { id: "guests", label: "Guests", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 14 }) },
    { id: "new", label: "New Event", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 14 }) }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: bgStyle, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        "aria-hidden": true,
        style: {
          ...
          width: 500,
          height: 500,
          background: "radial-gradient(circle, rgba(42,107,134,0.35) 0%, transparent 70%)",
          borderRadius: "50%",
          filter: "blur(60px)",
          pointerEvents: "none"
        }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          ...
          width: 450,
          height: 450,
          background: "radial-gradient(circle, rgba(139,77,125,0.3) 0%, transparent 70%)",
          borderRadius: "50%",
          filter: "blur(60px)",
          pointerEvents: "none"
        }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 min-h-screen p-3 sm:p-6 lg:p-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
            ...
            "nav",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-xl flex items-center justify-center text-white gradient-btn", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 14 }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                  ...
                  "div",
                  {
                    ...
                    children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        style: {
                          background: activeTab === tab.id && tab.id !== "new" ? "linear-gradient(135deg, rgba(111,168,255,0.35), rgba(185,140,255,0.35))" : "transparent",
                          color: activeTab === tab.id && tab.id !== "new" ? isDark ? "#F2F4FF" : "#1a1a2e" : isDark ? "#AEB6D0" : "#666",
                          border: activeTab === tab.id && tab.id !== "new" ? isDark ? "1px solid rgba(111,168,255,0.3)" : "1px solid rgba(111,168,255,0.25)" : "1px solid transparent"
                        },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: isDark ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { size: 14, style: { color: "#E0B34A" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { size: 14, style: { color: "#6FA8FF" } })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserRound, { size: 12 })
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Bell,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pt-8 pb-4 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "h1",
              {
                ...
                children: [
                  "Plan the ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Perfect Surprise" }),
                  " ",
                  "🎊"
                ]
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-sm",
                style: { color: isDark ? "#7D86A6" : "#888" },
                children: "Secretly plan unforgettable moments for the people you love"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "px-4 sm:px-6 pb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Notifications,
              {
                events: events2,
            ...
            activeTab === "dashboard" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 fade-in", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 flex-wrap", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    secretMode ? /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { size: 13, style: { color: "#B98CFF" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Eye,
                      {
                        size: 13,
                        style: { color: isDark ? "#AEB6D0" : "#888" }
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        style: {
                          background: secretMode ? "linear-gradient(135deg, #6FA8FF, #B98CFF)" : isDark ? "rgba(255,255,255,0.15)" : "rgba(0,0,0,0.15)",
                          width: "40px",
                          height: "22px",
                          borderRadius: "11px",
                          position: "relative",
              ...
              todayEvents.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "rounded-2xl p-4 mb-2",
                  style: {
                    background: isDark ? "rgba(111,168,255,0.12)" : "rgba(111,168,255,0.08)",
                    border: isDark ? "1px solid rgba(111,168,255,0.25)" : "1px solid rgba(111,168,255,0.2)"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "h3",
                      {
                        ...
                        style: { color: isDark ? "#6FA8FF" : "#4a7fd4" },
                        children: "🎉 Today's Surprises!"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: todayEvents.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      EventCard,
                      {
                        event: e,
                        secretMode,
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: "text-sm",
                          style: { color: isDark ? "#7D86A6" : "#bbb" },
                          children: "No upcoming surprises yet!"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          children: "Plan one now"
                        }
                      )
                    ]
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: upcomingEvents.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `upcoming.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  EventCard,
                  {
                    event: e,
                    secretMode,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
                ...
                completedEvents.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: "text-sm",
                        style: { color: isDark ? "#7D86A6" : "#bbb" },
                        children: "No completed events yet"
                      }
                    )
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3", children: completedEvents.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `completed.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  EventCard,
                  {
                    event: e,
                    secretMode,
            ...
            activeTab === "events" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 fade-in", children: [
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: filteredEvents.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        style: {
                          background: isDark ? "rgba(255,100,100,0.15)" : "rgba(255,100,100,0.1)"
                        },
                        title: "Delete event",
            ...
            activeTab === "guests" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 fade-in", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  className: "text-lg font-semibold",
    ...
    revealingEvent && /* @__PURE__ */ jsxRuntimeExports.jsx(
      PasswordModal,
      {
        eventTitle: revealingEvent.title,
        isDark,
        onConfirm: handlePasswordConfirm,
        onCancel: () => setRevealingEvent(void 0)
      }
    ),
